...
export const TerminalView = forwardRef<TerminalViewHandle, Props>(
  ({ conn, onDisconnect, onSocketEvent, onTitleChange, onCwdChange, onCodexSignal, onOutput, onSwipe }, ref) => {
  ...
  const updateAtBottom = useCallback(() => {
    ...
    const wantsScrubber = isSmallScreenRef.current;
    const viewport = viewportRef.current;
  ...
  }, [applyFontSize, focusTerminal, moveCursorToPoint, onSwipe, scheduleScrollCheck]);
